...
sys.path.insert(1, "E:\graph gnn\GraphINVENT\graphinvent\parameters")  # search "parameters/" directory
import graphinvent.parameters.args as args
import graphinvent.parameters.defaults as defaults
